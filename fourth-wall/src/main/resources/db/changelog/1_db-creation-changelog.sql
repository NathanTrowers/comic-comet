...
CREATE TABLE comic_book_order (
	...
	CONSTRAINT fk_customer_id_comic_book_order FOREIGN KEY(customer_id) REFERENCES customer(customer_id),
	CONSTRAINT fk_comic_book_comic_book_order FOREIGN KEY(comic_book_id) REFERENCES comic_book(comic_book_id) ON DELETE RESTRICT
);
