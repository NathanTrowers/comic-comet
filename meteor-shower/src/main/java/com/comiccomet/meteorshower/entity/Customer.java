...
public class Customer {
    ...
    public Set<ComicBookOrder> getComicBookOrder() {
        return this.comicBookOrder;
    }

    public void setComicBookOrder(Set<ComicBookOrder> comicBookOrder) {
        this.comicBookOrder = comicBookOrder;
    }
